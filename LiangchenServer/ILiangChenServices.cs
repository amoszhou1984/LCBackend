...
namespace LiangchenServer
{
    ...
    public interface ILiangChenServices
    {
        ...
        [WebInvoke(Method = "POST", UriTemplate = "Event/Delete", RequestFormat = WebMessageFormat.Json)]
        ...
        [WebInvoke(Method = "POST", UriTemplate = "Event/ListCreated", RequestFormat = WebMessageFormat.Json)]
        ...
        [WebInvoke(Method = "POST", UriTemplate = "Event/Detail", RequestFormat = WebMessageFormat.Json)]
        string EventDetail(Stream requestData);

        [OperationContract(Name = "AddParticipant")]
        [WebInvoke(Method = "POST", UriTemplate = "Participant/Add", RequestFormat = WebMessageFormat.Json)]
        bool AddParticipant(Stream participantData);

        [OperationContract(Name = "DelParticipant")]
        [WebInvoke(Method = "POST", UriTemplate = "Participant/Del", RequestFormat = WebMessageFormat.Json)]
        bool DelParticipant(Stream participantData);

        [OperationContract(Name = "EditParticipant")]
        [WebInvoke(Method = "POST", UriTemplate = "Participant/Edit", RequestFormat = WebMessageFormat.Json)]
        bool EditParticipant(Stream participantData);

        [OperationContract(Name = "AddTimeslot")]
        [WebInvoke(Method = "POST", UriTemplate = "Timeslot/Add", RequestFormat = WebMessageFormat.Json)]
        bool AddTimeslot(Stream eventData);

        [OperationContract(Name = "DelTimeslot")]
        [WebInvoke(Method = "POST", UriTemplate = "Timeslot/Del", RequestFormat = WebMessageFormat.Json)]
        bool DelTimeslot(Stream eventData);

        [OperationContract(Name = "EditTimeslot")]
        [WebInvoke(Method = "POST", UriTemplate = "Timeslot/Edit", RequestFormat = WebMessageFormat.Json)]
